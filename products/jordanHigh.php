...
<head>
    ...
    <title>TOPKICKS - Jordan 1 High</title>
...
<body>
    ...
    <?php
        ...
        $consulta="SELECT * FROM produtos WHERE modelo = 'Air Jordan 1 High' $ordenar_por";
    ...
    <div class="brandOptions">
        ...
        <div class="options mx-auto">
            ...
            <a href="jordanMid.php">Jordan 1 Mid</a>
            <a href="jordanHigh.php">Jordan 1 High</a>
        </div>
        <img src="../images/nike_logo.png" class="mr-md-5 pr-md-2" alt="">
    </div>

    <h3 class='text-center' style='padding-top: 10%; padding-bottom: 10%;'>Disponível em breve...</h3>
