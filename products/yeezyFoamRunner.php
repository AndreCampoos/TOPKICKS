...
<head>
    ...
    <title>TOPKICKS - Yeezy Foam Runner</title>
...
<body>
    ...
    <?php
        ...
        $consulta="SELECT * FROM produtos WHERE modelo = 'Yeezy Foam Runner' $ordenar_por";
    ...
    <div class="brandOptions">
        <img src="../images/adidas_logo.png" class="ml-md-4 pl-md-2" alt="">
        <div class="options mx-auto">
            <a href="yeezySlide.php">Yeezy Slide</a>
            <a href="yeezyBoost.php">Yeezy Boost 350</a>
            <a href="yeezyFoamRunner.php">Yeezy Foam Runner</a>
        </div>
        <img src="../images/adidas_logo.png" class="mr-md-5 pr-md-2" alt="">
    </div>

    <div class="product-row pb-md-4">
        <?php
