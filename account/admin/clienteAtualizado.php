...
<body>
    ...
    <?php
        ...
        $atualiza="UPDATE clientes SET nome='".$nome."',email='".$email."',telemovel='".$telemovel."',perfil='".$perfil."' WHERE codcliente='".$codcliente."'";
        ...
        echo "<h1 class='mt-md-3'>Cliente Atualizado</h1>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
        ...
        if ($resultado==1) {
            echo "<form method='POST' action='clienteAtualizado.php?codcliente=echo $codcliente'>";
            ...
            echo "</table>";
            echo "<a href='editarCliente.php'>← Voltar</a>";
            echo "</form>";
        }
