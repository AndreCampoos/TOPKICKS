...
<head>
    ...
    <title>TOPKICKS - Inserir Cliente</title>
...
<body>
    ...
    <?php
        ...
        echo "<h1 class='mt-md-3'>Inserir Cliente</h1>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
    ...
    <form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
        <div class="box-create col-md-4 mx-auto">
            <div class="form">
                ...
                <div class="inputBox mx-auto">
                    <input type="text" name="tlm" id="tlmnumero" required="required" maxlength="14" value='+351 ' autocomplete="off">
                    <span>Telefone</span>
                    <i></i>
                </div>
                ...
                <div class="inputBox mx-auto">
                    <input type="text" name="perfil" id="idperfil" required="required" value='adm / user' autocomplete="off">
                    <span>Perfil</span>
                    <i></i>
                </div>
    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            if (empty ($nome) || empty ($password) || empty ($confirm) || empty ($email) || empty ($numtlm) || empty ($perfil)){
                ...
                $msg=registaUtilizador($nome, $email, $password, $numtlm, $perfil);
            }
        }
        ...
        function registaUtilizador($nome, $email, $password, $numtlm, $perfil) {
            ...
            if($mailExiste){
                ...
                include("../../config.php");
                $query = "INSERT INTO clientes (nome,password,email,telemovel,perfil) VALUES ('$nome','$pass','$email','$numtlm','$perfil')";
                $resultado = mysqli_query($liga,$query);
                if($resultado == true) {
