...
<body>
    ...
    <?php
        ...
        echo "<h1 class='mt-md-3'>Clientes</h1>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
        echo "<div class='horizontal_line mb-md-2 ml-md-0'></div>";

        echo "<h3 class='mt-md-4 text-right' style='margin-right: 7.3%; font-family: iran_sans_bold;'>Foram encontrados $nClientes clientes.</h3>";
