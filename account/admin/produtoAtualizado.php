...
<body>
    ...
    <?php
        ...
        if (!$marca || !$modelo || !$submodelo || !$img0 || !$img1 || !$img2 || !$img3 || !$img4 || !$preco || !$descricao) {
        ...
        $atualiza="UPDATE produtos SET marca='".$marca."',modelo='".$modelo."',submodelo='".$submodelo."',img0='".$img0."',img1='".$img1."',img2='".$img2."',img3='".$img3."',img4='".$img4."',preco='".$preco."',descricao='".$descricao."' WHERE codigo='".$codigo."'";
        ...
        echo "<h1 class='mt-md-3'>Produto Atualizado</h1>";
        echo "</div>";
        echo "</div>";
        echo "</div>";
        ...
        if ($resultado==1) {
            echo "<form method='POST' action='produtoAtualizado.php?codigo=echo $codigo'>";
