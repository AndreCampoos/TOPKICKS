...
<body>
    ...
    <?php
        ...
        $consultaClientes="SELECT * FROM clientes WHERE codcliente='".$codcliente."'";
        $resultadoClientes=mysqli_query($liga,$consultaClientes);
        $nClientes=mysqli_num_rows($resultadoClientes);
        $registo=mysqli_fetch_array($resultadoClientes);
        ...
        echo "<form method='POST' action='clienteAtualizado.php?codcliente=$codcliente'>";
        ...
        echo "<td>";
        echo "<input type='text' name='nome' value='{$registo['nome']}'>";
        echo "</td>";
        ...
        echo "<td>";
        echo "<input type='text' name='telemovel'  maxlength='9' value='{$registo['telemovel']}'>";
        echo "</td>";
