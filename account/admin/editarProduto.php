...
<body>
    ...
    echo "<form method='GET' action='atualizarProduto.php'";
    echo "<label for='codcliente'>Código do Produto - </label>";
    echo "<input type='text' class='mr-md-1' name='codigo' id='idcodigo' required>";
    ...
    for ($i = 0; $i < $nProdutos; $i++) {
        ...
        echo "<td>" . $registo['img0'] . "</td>";
        echo "<td>" . $registo['img1'] . "</td>";
        echo "<td>" . $registo['img2'] . "</td>";
        echo "<td>" . $registo['img3'] . "</td>";
        echo "<td>" . $registo['img4'] . "</td>";
        echo "<td>" . $registo['preco'] . "</td>";
        echo "<td>" . $registo['descricao'] . "</td>";
        echo "</tr>";
    }
    echo "</table>";
